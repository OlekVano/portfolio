    ...
    <div className={styles.toolsAndTechnologies} >
      <div className={styles.container} >
        ...
        <div className={styles.tools} style={{marginTop: '5vw'}} >
          ...
          <div className={styles.bigTool}><a target='_blank' rel='noopener noreferrer' href='https://sass-lang.com' className={styles.bubble}><img alt='SCSS logo' className={styles.image} src={scssLogo} /></a></div>
